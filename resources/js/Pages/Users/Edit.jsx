    ...
    return (
        <Layout user={auth.user}>
            <div className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-lg shadow max-w-2xl">
                <h2 className="text-xl sm:text-2xl font-bold mb-6 text-gray-900 dark:text-white">Edit User</h2>
                <form onSubmit={submit}>
                    ...
                    <div className="mb-4">
                        <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password (leave blank to keep current)</label>
                        <input
                            type="password"
                            value={data.password}
